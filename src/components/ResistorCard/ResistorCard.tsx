...
const ResistorCard = ({resistor,  showAddBtn=false, showRemoveBtn=false, editMM=false}:Props) => {
    ...
    const [local_voltage, setLocal_voltage] = useState(resistor.voltage)
                ...
                <Row>
                    ...
                    <Col md={8}>
                        <CardBody>
                            ...
                            <CustomInput label="Напряжение" type="number" value={local_voltage} setValue={setLocal_voltage} disabled={!editMM || is_superuser} className={"w-25"}/>
